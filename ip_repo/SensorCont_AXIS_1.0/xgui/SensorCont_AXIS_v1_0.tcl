...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FULL_CONTROL" -parent ${Page_0}
  ipgui::add_param $IPINST -name "NUMBER_OF_DOF" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox
...
proc update_PARAM_VALUE.FULL_CONTROL { PARAM_VALUE.FULL_CONTROL } {
	# Procedure called to update FULL_CONTROL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FULL_CONTROL { PARAM_VALUE.FULL_CONTROL } {
	# Procedure called to validate FULL_CONTROL
	return true
}

proc update_PARAM_VALUE.NUMBER_OF_DOF { PARAM_VALUE.NUMBER_OF_DOF } {
	# Procedure called to update NUMBER_OF_DOF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUMBER_OF_DOF { PARAM_VALUE.NUMBER_OF_DOF } {
	# Procedure called to validate NUMBER_OF_DOF
	return true
}
...
proc update_MODELPARAM_VALUE.NUMBER_OF_DOF { MODELPARAM_VALUE.NUMBER_OF_DOF PARAM_VALUE.NUMBER_OF_DOF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUMBER_OF_DOF}] ${MODELPARAM_VALUE.NUMBER_OF_DOF}
}

proc update_MODELPARAM_VALUE.FULL_CONTROL { MODELPARAM_VALUE.FULL_CONTROL PARAM_VALUE.FULL_CONTROL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FULL_CONTROL}] ${MODELPARAM_VALUE.FULL_CONTROL}
}
